...
class ArrangementItemController {
  async index({ auth, request, response }) {
    try {
      ...
      if (showed == "private") {
        query.where("uploaded_by", userLogged.id);
      }
  ...
  async create({ auth, request, response }) {
    try {
      ...
      const messages = {
        ...
        "showed.required": "Isi Tatanan Diperlihatkan Harus Diisi",
        "showed.in":
          "Isi Tatanan Diperlihatkan Harus Diisi : public, member, dan private",
      };
